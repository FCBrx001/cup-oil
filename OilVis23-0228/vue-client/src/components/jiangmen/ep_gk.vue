<template>
    <div> 
        ...
        <el-table
            ...
            <el-table-column prop="valve_state" label="MOV019阀门状态" width="128" :formatter="valve_stateFormat"></el-table-column>
            <el-table-column prop="valve_leakage" label="MOV019阀门内漏状态" width="128" :formatter="valve_leakageFormat"></el-table-column>
            <el-table-column prop="pig_state" label="清管状态" width="128" :formatter="pig_stateFormat"></el-table-column>
            <!-- <el-table-column prop="pump_state" label="主输泵" style='width: 5%' :formatter="pump_stateFormat"></el-table-column> -->
    ...
    export default{
        ...
        methods: {
            ...
            changeeventdia(row)
            {
                ...
                eventBus.$emit('jm_gk_zql_error',this.eventerror_times)
                //处理事件状态逻辑
                console.log('更改当前行',row)
            ...
            eventsuredia(row){
                //连接ep_gk_zql组件
                this.eventsure_times++
                eventBus.$emit('jm_gk_zql_sure',this.eventsure_times)
                //处理事件状态逻辑
                console.log('更改当前行',row)
                for(let i=0;i<5;i++)
                {
