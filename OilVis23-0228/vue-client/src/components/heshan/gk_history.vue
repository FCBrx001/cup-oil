    ...
    <div> 
        ...
        <div style="width:100%">
            ...
            <el-table
                ...
                <el-table-column prop="datetime" label="时间"  width="120" ></el-table-column>
                
                <el-table-column prop="valve_state" label="EOV011阀门状态" width="100" :formatter="valve_stateFormat"></el-table-column>
                <el-table-column prop="valve_leakage" label="EOV011阀门内漏状态" width="100" :formatter="valve_leakageFormat"></el-table-column>
                <el-table-column prop="pig_state" label="清管状态" width="75" :formatter="pig_stateFormat"></el-table-column>
                <el-table-column prop="pump_state" label="主输泵状态" width="80" :formatter="pump_stateFormat"></el-table-column>
                <el-table-column prop="state" width="90" label="处理状态" ></el-table-column>
        ...
        methods: {
            ...
            loadpage(){
                ...
                this.$axios({
                    ...
                    let data = {
                        'station':'鹤山',
                        'datetime':'2024-04-02 16:16:50',
                        'valve_state':'close',
                        'valve_leakage':'leakage',
                        'pig_state':'normal',
                        'state':'未处理'
                    ...
                    this.tabledetailData.push(data1)
                    this.tabledetailData.push(data)
                    // this.tabledetailData.push(res.data[0])
                    // this.tabledetailData.push(data)
