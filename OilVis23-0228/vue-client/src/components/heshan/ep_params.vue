    ...
    export default{
        ...
        data(){
            return {
                ...
                hszd:{
                    STN05_00_FT004:'进站流量1(m³/h)',STN05_00_FI003:'进站流量2(m³/h)',STN05_02_FIQ201:'累计下载流量1(t)',
                    STN05_02_FIQ202:'累计下载流量2(t)',STN05_00_FIQ003:'进站累计流量(m³/h)',STN05_00_PI001:'进站压力1(MPa)',
                    STN05_00_PI001A:'进站压力2(MPa)',STN05_00_DI001A:'进站密度(kg/m³)',STN05_00_TI001:'进站温度(℃)',
                    STN05_02_FIC201:'下载流量1(t/h)',STN05_02_FIC202:'下载流量2(t/h)',
                    STN05_00_TI002:'出站温度',
                    STN05_00_DI201:'下载密度1(kg/m³)',STN05_00_DI202:'下载密度2(kg/m³)',
                    STN05_00_PI012B:'出站压力1(MPa)',STN05_00_PI011:'出站压力2(MPa)',STN05_00_PI011A:'出站压力3(MPa)',

                    STN05_00_PI004:'减压阀前压力(MPa)',STN05_00_PIC005:'减压阀后压力(MPa)',STN05_00_PIC007:'主输入泵入口压力(MPa)',
                    STN05_00_PI008:'主输入泵出口汇管压力1(MPa)',STN05_00_PI009A:'主输入泵出口汇管压力2(MPa)',STN05_00_PI009B:'主输入泵出口汇管压力3(MPa)',
                    STN05_00_PI006B:'减压阀后压力B(MPa)',STN05_00_PI006A:'减压阀后压力A(MPa)'
                },
                ...
                value: [],
                checkedvalue:['STN05_00_PI001','STN05_00_PI012B'],
            ...
            paramsdatainit(){
                ...
                this.$axios({
                    ...
                    for(var i=0;i<res.data.length;i++){
                        ...
                        // obj['name'] = res.data[i]
                         let name = Object.keys(this.hszd)
                        if(name.includes(`${res.data[i]}`)){
                            obj['value'] = res.data[i]
                            obj['name'] = this.hszd[`${res.data[i]}`]
                            obj['check'] = false
                            option.push(obj)
                        }   
                        // obj['value'] = res.data[i]
