    ...
    <div> 
        ...
        <div style="width:100%">
            ...
            <el-table
                ...
                <el-table-column prop="valve_state" label="MOV220阀门状态" width="100" :formatter="valve_stateFormat"></el-table-column>
                <el-table-column prop="valve_leakage" label="MOV220阀门内漏状态" width="100" :formatter="valve_leakageFormat"></el-table-column>
