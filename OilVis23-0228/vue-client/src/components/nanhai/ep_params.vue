    ...
    export default{
        ...
        data(){
            return {
                ...
                nhzd:{
                    STN21_00_FI001:'进站流量(m³/h)',
                    STN21_00_PI001:'进站压力1(MPa)',
                    STN21_00_PI001A:'进站压力2(MPa)',
                    STN21_00_DI001A:'进站密度(kg/m³)',
                    STN21_00_TI001:'进站温度(℃)',
                    STN21_02_FIC201:'下载流量1(t/h)',
                    STN21_02_FIQ201:'累计下载流量1(t)',
                    STN21_02_FIC202:'下载流量2(t/h)',
                    STN21_02_FIQ202:'累计下载流量2(t)',
                    STN21_00_DI201:'下载密度1(kg/m³)',
                    STN21_00_DI202:'下载密度2(kg/m³)',

                    STN21_00_PI004:'减压阀前压力(MPa)',
                    STN21_00_PIC005:'减压阀后压力1(MPa)',
                    STN21_00_PI006A:'减压阀后压力2(MPa)',
                    STN21_00_PI006B:'减压阀后压力3(MPa)',
                },
            ...
            paramsdatainit(){
                ...
                this.$axios({
                    ...
                    for(var i=0;i<res.data.length;i++){
                        ...
                        // obj['name'] = res.data[i]
                         let name = Object.keys(this.nhzd)
                        if(name.includes(`${res.data[i]}`)){
                            obj['value'] = res.data[i]
                            obj['name'] = this.nhzd[`${res.data[i]}`]
                            obj['check'] = false
                            option.push(obj)
                        }   
                        // obj['value'] = res.data[i]
