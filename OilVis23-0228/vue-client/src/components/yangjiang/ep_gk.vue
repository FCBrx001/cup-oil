<template>
    <div> 
        ...
        <el-table
            ...
            <el-table-column prop="station" label="站名" width="100"></el-table-column>
            ...
            <el-table-column prop="valve_state" label="MOV015阀门状态" width="110" :formatter="valve_stateFormat"></el-table-column>
            <el-table-column prop="valve_leakage" label="MOV015阀门内漏状态" width="110" :formatter="valve_leakageFormat"></el-table-column>
            <el-table-column prop="pig_state" label="清管状态" width="110" :formatter="pig_stateFormat"></el-table-column>
            <el-table-column prop="pump_state" label="主输泵状态" width="110" :formatter="pump_stateFormat"></el-table-column>
            <el-table-column prop="state" label="处理状态" width="110"></el-table-column>
        ...
        <el-dialog title="历史工况表单" :visible.sync="tabledetailVisible" style="width:100%" >
            ...
            <div>
                <el-table
                    ...
                    <el-table-column prop="station" label="站名" style='width: 5%' ></el-table-column>
                    <el-table-column prop="uuid" label="警告Id" v-if="false" style='width: 5%' ></el-table-column>
                    <el-table-column prop="datetime" label="时间"  style='width: 8%' ></el-table-column>
                    <el-table-column prop="valve_state" label="MOV015阀门状态" style='width: 5%' :formatter="valve_stateFormat"></el-table-column>
                    <el-table-column prop="valve_leakage" label="MOV015阀门内漏状态" style='width: 5%' :formatter="valve_leakageFormat"></el-table-column>
                    <el-table-column prop="pig_state" label="清管状态" style='width: 2%' :formatter="pig_stateFormat"></el-table-column>
                    <el-table-column prop="pump_state" label="主输泵状态" style='width: 5%' :formatter="pump_stateFormat"></el-table-column>
                    <el-table-column prop="state" label="处理状态" style='width: 10%'></el-table-column>
...
<script>
    ...
    export default{
        ...
        mounted(){
            ...
            eventBus.$on('yj_datawarn',data=>{
                //data是一个数组
                console.log('yj_datawarn',data)
                
                //将第一次的值赋值给lastonedata
                // if(this.lastonedata==null)
                // {
                //     this.lastonedata = data[0]
                // }
        ...
        methods: {
            ...
            setCellColor2({row,column,rowIndex,columnIndex}) {
                ...
                if(columnIndex==6)
                {
                    ...
                    if(row.state=='未处理')
                    {
                        return 'color:#fc8452;text-align:center;font-wight:500;fontSize:20px;background-color: #003b5c;'
                    } 
                    else{
            ...
            changeeventdia(row)
            {
                ...
                eventBus.$emit('yj_gk_zql_error',this.eventerror_times)
                //处理事件状态逻辑
                console.log('更改当前行',row)
            ...
            eventsuredia(row){
                //连接ep_gk_zql组件
                this.eventsure_times++
                eventBus.$emit('yj_gk_zql_sure',this.eventsure_times)
                //处理事件状态逻辑
                console.log('更改当前行',row)
                for(let i=0;i<5;i++)
                {
