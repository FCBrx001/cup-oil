        ...
        methods: {
            ...
            getdata(){
                ...
                this.$axios({
                    ...
                    this.data_fmnl[0].value = res.data[1].confirm_time
                    this.data_fmnl[1].value = res.data[1].edit_time

                    this.data_kgf[0].value = res.data[2].confirm_time
                    this.data_kgf[1].value = res.data[2].edit_time

                    this.data_sb[0].value = res.data[3].confirm_time
                    this.data_sb[1].value = res.data[3].edit_time

                    this.data_qg[0].value = res.data[4].confirm_time
                    this.data_qg[1].value = res.data[4].edit_time
                })
