    ...
    <div> 
        <div style="width:100%">
            ...
            <el-table
                ...
                <el-table-column prop="station" label="站名" width="80"></el-table-column>                
                ...
                <el-table-column prop="valve_state" label="MOV220阀门状态" width="110" :formatter="valve_stateFormat"></el-table-column>
                <el-table-column prop="valve_leakage" label="MOV220阀门内漏状态" width="110" :formatter="valve_leakageFormat"></el-table-column>
                <el-table-column prop="pig_state" label="清管状态" width="100" :formatter="pig_stateFormat"></el-table-column>
                <!-- <el-table-column prop="pump_state" label="主输泵" width="95" :formatter="pump_stateFormat"></el-table-column> -->
                <el-table-column prop="state" label="处理状态" width="90"></el-table-column>
            
                <el-table-column :render-header="renderHeader" width="220">
        ...
        methods: {
            ...
            loadpage(){
                ...
                this.$axios({
                    ...
                    let data = {
                      'station':'花都',
                       'datetime':'2024-04-11 15:46:50',
                     'valve_state':'open',
                      'valve_leakage':'normal',
                      'pig_state':'JMZpig',
                       'state':'未处理'
                    ...
                    //  console.log('返回数据',this.tabledetailData)
                })
            },
