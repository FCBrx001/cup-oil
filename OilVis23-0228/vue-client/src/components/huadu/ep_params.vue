<template>
    <div style="width:100%; float:center">
        ...
        <!-- <span>参数查询</span> -->
            ...
            <el-select  style="width:25%;font-size: 50px"  v-model="value" multiple collapse-tags placeholder="进站压力1" @change="(val) =>changeval(val)">
                <el-row>
                    <el-col>
    ...
    export default{
        ...
        data(){
            return {
                ...
                hdzd:{
                    STN22_00_FI003:'进站流量(m³/h)',
                    STN22_00_PI001:'进站压力1(MPa)',
                    STN22_00_PI001A:'进站压力2(MPa)',
                    STN22_00_DI001A:'进站密度(kg/m³)',
                    STN22_00_TI001:'进站温度(℃)',
                    STN22_02_FIC201:'下载流量1(t/h)',
                    STN22_02_FIQ201:'累计下载流量1(t)',
                    STN22_02_FIC202:'下载流量2(t/h)',
                    STN22_02_FIQ202:'累计下载流量2(t)',
                    STN22_00_DI201:'下载密度1(kg/m³)',
                    STN22_00_DI202:'下载密度2(kg/m³)',

                    STN22_00_PI004:'减压阀前压力(MPa)',
                    STN22_00_PIC005:'减压阀后压力1(MPa)',
                    STN22_00_PI006A:'减压阀后压力2(MPa)',
                    STN22_00_PI006B:'减压阀后压力3(MPa)'
                },
                tableData: [{
					station: '恩平站',
					event_type: '工况报警',
            ...
            paramsdatainit(){
                ...
                this.$axios({
                    ...
                    for(var i=0;i<res.data.length;i++){
                        ...
                        // obj['name'] = res.data[i]
                         let name = Object.keys(this.hdzd)
                        if(name.includes(`${res.data[i]}`)){
                            obj['value'] = res.data[i]
                            obj['name'] = this.hdzd[`${res.data[i]}`]
                            obj['check'] = false
                            option.push(obj)
                        }   
                        // obj['value'] = res.data[i]
