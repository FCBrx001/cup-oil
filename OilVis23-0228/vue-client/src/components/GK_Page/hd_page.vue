                ...
                <div class="left_gk fl">
                    ...
                    <div class="data-box1 left_tb box1-backlu fl " >
                        ...
                        <div class="data-title" style="width:13rem;">
                            ...
                            <span style="font-size:1.5rem;width:12rem;">花都站信息</span>
                    ...
                    <div class="data-box1 left_tb box1-backld fl mtop40">
                        ...
                        <div class="data-title" style="width:13rem;">
                            <b class="data-title-left fl">[</b>
                            <span style="font-size:1.5rem;width:12rem;">花都站信息统计</span>
                            <b class="data-title-right fr">]</b>
                        </div>
                            <!-- 项目人员信息状态-->
                        <div class="xmglan">        
                            <div class="wgrytj">
                                <span class="wgrytj_bt" style="font-size:1.2rem;width:95%;">花都站工况统计
                            ...
                            <div class="wgrytj">
                                <span class="wgrytj_bt" style="font-size:1.2rem;">花都站工况准确率统计</span>
                                <div class="wgrytj_tb">
                                    <div id="gztj" style="height:33%">
                                        <epgkzql></epgkzql>
                                    </div>                    
                            ...
                            <div class="wgrytj">
                                <span class="wgrytj_bt" style="font-size:1.2rem;">花都站工况占比统计</span>
                                <div class="wgrytj_tb">
...
<script>
    ...
    import ep_gk from '../huadu/ep_gk.vue'
    import ep_params from '../huadu/ep_params.vue'   
    import ep_gkstatis from '../huadu/ep_gkstatis.vue'
    import ep_gk_zql from '../huadu/ep_gk_zql.vue'
    import ep_fmtable from '../huadu/ep_fmtable.vue'
    import ep_fmstatis from '../huadu/ep_fmstatis.vue'
    import gk_history from '../huadu/gk_history.vue'
    import hd_gongyi from '../huadu/hd_gongyi.vue'
    export default {
        name: 'home',
        components:{
            'epgk':ep_gk,
        ...
        methods:{
            ...
            selectChanged(value){
                ...
                eventBus.$emit('hd_gk_statis',value)
            },
            ...
            warn_check(){
				...
				this.$axios({
                    ...
                    eventBus.$emit('hd_warn',this.warndata)
