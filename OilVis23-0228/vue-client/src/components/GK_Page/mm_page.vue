            ...
            <div class="left_gk fl">
                ...
                <div class="data-box1 left_tb box1-backlu fl ">
                    ...
                    <div class="data-title" style="width:13rem;">
                        ...
                        <span style="font-size:1.5rem;width:12rem;">茂名站信息</span>
                        ...
                        <div id="xmgl_cen">
                            <div class="xmgl_tb">
                                <ul class="xm_cszs">
                                    ...
                                    <li style="font-size:1.5rem;">设备参数：<span style="font-size:1.5rem;">21</span>个</li>
                                    <li> <span> </span> </li>
                                    <li> <span> </span></li>
                                </ul>
                            </div>
                ...
                <div class="data-box1 left_tb box1-backld fl mtop40">
                    ...
                    <div class="data-title" style="width:13rem;">
                        <b class="data-title-left fl">[</b>
                        <span style="font-size:1.5rem;width:12rem;">茂名站信息统计</span>
                        <b class="data-title-right fr">]</b>
                    </div>
                    <!-- 项目人员信息状态-->
                    <div class="xmglan">
                        <div class="wgrytj" style="height:33%">
                            <span class="wgrytj_bt" style="font-size:1.2rem;width:95%;">茂名站工况统计
                                <el-select style="width:40%;float: right;" v-model="value" placeholder="阀门内漏"
                        ...
                        <div class="wgrytj" style="height:33%">
                            <span class="wgrytj_bt" style="font-size:1.2rem;">茂名站工况准确率统计</span>
                            <div class="wgrytj_tb">
                                <div id="gztj">
                                    <epgkzql></epgkzql>
                                </div>
                        ...
                        <div class="wgrytj" style="height:33%">
                            <span class="wgrytj_bt" style="font-size:1.2rem;">茂名站工况占比统计</span>
                            <div class="wgrytj_tb">
                                <div id="xcrytj">
...
import ep_params from '../maoming/ep_params.vue'

import mm_gongyi from '../maoming/mm_gongyi.vue'
import ep_gkstatis from '../maoming/ep_gkstatis.vue'
import ep_gk_zql from '../maoming/ep_gk_zql.vue'
import ep_fmtable from '../maoming/ep_fmtable.vue'
import ep_fmstatis from '../maoming/ep_fmstatis.vue'

import gk_history from '../maoming/gk_history.vue'
...
export default {
    ...
    mounted() {
        // eventBus.$on('mm_warndata',data=>{
        //     console.log('mmpage接收',data)
        // })
    ...
    methods: {
        ...
        selectChanged(value) {
            ...
            eventBus.$emit('mm_gk_statis', value)
        },
        ...
        warn_check() {
            ...
            this.$axios({
                ...
                console.log('茂名AJXS：', this.warndata)
                ...
                eventBus.$emit('mm_warn', this.warndata)
