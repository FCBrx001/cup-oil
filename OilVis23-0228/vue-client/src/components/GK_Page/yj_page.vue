                ...
                <div class="left_gk fl">
                    ...
                    <div class="data-box1 left_tb box1-backlu fl " >
                        ...
                        <div class="data-title" style="width:13rem;">
                            ...
                            <span style="font-size:1.5rem;width:12rem;">阳江站信息</span>
                        ...
                        <div class="xmglan">        
                            ...
                            <div id="xmgl_cen">              
                                <div class="xmgl_tb">
                                    ...
                                    <li style="font-size:1.5rem;">设备参数：<span style="font-size:1.5rem;">23</span>个</li>
                                    <li> <span> </span> </li>
                                    <li> <span> </span></li>
                                    </ul>
                                </div>             
                    ...
                    <div class="data-box1 left_tb box1-backld fl mtop40">
                        ...
                        <div class="data-title" style="width:13rem;">
                            <b class="data-title-left fl">[</b>
                            <span style="font-size:1.5rem;width:12rem;">阳江站信息统计</span>
                            <b class="data-title-right fr">]</b>
                        </div>
                            <!-- 项目人员信息状态-->
                        <div class="xmglan">        
                            <div class="wgrytj">
                                <span class="wgrytj_bt" style="font-size:1.2rem;width:95%;">阳江站工况统计
                            ...
                            <div class="wgrytj">
                                <span class="wgrytj_bt" style="font-size:1.2rem;">阳江站工况准确率统计</span>
                                <div class="wgrytj_tb">
                                    <div id="gztj" style="height:33%">
                                        <epgkzql></epgkzql>
                                    </div>                    
                            ...
                            <div class="wgrytj">
                                <span class="wgrytj_bt" style="font-size:1.2rem;">阳江站工况占比统计</span>
                                <div class="wgrytj_tb">
...
<script>
    ...
    import ep_gk from '../yangjiang/ep_gk.vue'
    import ep_params from '../yangjiang/ep_params.vue'
    import ep_gkstatis from '../yangjiang/ep_gkstatis.vue'
    import ep_gk_zql from '../yangjiang/ep_gk_zql.vue'
    import ep_fmtable from '../yangjiang/ep_fmtable.vue'
    import ep_fmstatis from '../yangjiang/ep_fmstatis.vue'
    import yj_gongyi from '../yangjiang/yj_gongyi.vue'
    import gk_history from '../yangjiang/gk_history.vue'
    ...
    export default {
        ...
        methods:{
            ...
            selectChanged(value){
                ...
                eventBus.$emit('yj_gk_statis',value)
            },
            ...
            warn_check(){
				...
				this.$axios({
                    ...
                    eventBus.$emit('yj_warn',this.warndata)
