<template>
    <div style="width:100%; float:center">
        ...
        <el-select style="width:25%;font-size: 50px" v-model="value" multiple collapse-tags placeholder="进站压力、出站压力"
            @change="(val) => changeval(val)">
            <el-row>
                <el-col>

                    <el-option v-for="item in optionsA" :key="item.value" :label="item.name"
        ...
        <el-date-picker style="width:20%" size="large" v-model="start_value" type="date" placeholder="2023-03-02 00:00:00"
            format="yyyy-MM-dd" value-format="yyyy-MM-dd HH:mm:ss">
        </el-date-picker>

        <el-date-picker style="width:20%" size="large" v-model="over_value" type="date" placeholder="2023-03-03 00:00:00"
            format="yyyy-MM-dd" value-format="yyyy-MM-dd HH:mm:ss">
        </el-date-picker>
...
export default {
    ...
    data() {
        return {
            ...
            gmzd: {
                STN19_00_FI003: '进站流量(m³/h)',
                STN19_00_FIQ003: '进站累计流量(m³/h)',
                STN19_00_PI001: '进站压力1(MPa)',
                STN19_00_PI001A: '进站压力2(MPa)',
                STN19_00_DI001A: '进站密度(kg/m³)',
                STN19_00_TI001: '进站温度(℃)',
                STN19_02_FIC201: '下载流量1(t/h)',
                STN19_02_FIQ201: '累计下载流量1(t)',
                STN19_02_FIC202A: '下载流量2(t/h)',
                STN19_02_FIQ202A: '累计下载流量2(t)',
                STN19_02_FIC202: '下载流量3(t/h)',
                STN19_02_FIQ202: '累计下载流量3(t)',

                STN19_00_DI201: '下载密度1(kg/m³)',
                STN19_00_DI202A: '下载密度2(kg/m³)',
                STN19_00_DI202: '下载密度3(kg/m³)',
                STN19_00_PI027: '出站压力1(MPa)',
                STN19_00_PI027A: '出站压力2(MPa)',
                STN19_00_FI003: '出站流量(m³/h)',
                STN19_00_TI002: '出站温度(℃)',


                STN19_00_PI004: '减压阀前压力(MPa)',
                STN19_00_PIC005: '减压阀后压力1(MPa)',
                STN19_00_PIC006A: '减压阀后压力2(MPa)',
                STN19_00_PIC006B: '减压阀后压力3(MPa)',
                STN19_00_PI022A: '主输泵入口压力(MPa)',
                STN19_00_PI036A: '主输泵出口汇管压力1(MPa)',
                STN19_00_PI036B: '主输泵出口汇管压力2(MPa)',
                STN19_00_PI036C: '主输泵出口汇管压力3(MPa)',
            },
            ...
            value: [],
            checkedvalue: ['STN19_00_PI001', 'STN19_00_PI027'],
        ...
        paramsdatainit() {
            ...
            this.$axios({
                ...
                for (var i = 0; i < res.data.length; i++) {
                    ...
                    // obj['name'] = res.data[i]
                    let name = Object.keys(this.gmzd)
                    if (name.includes(`${res.data[i]}`)) {
                        obj['value'] = res.data[i]
                        obj['name'] = this.gmzd[`${res.data[i]}`]
                        obj['check'] = false
                        option.push(obj)
                    }
                    // obj['value'] = res.data[i]
