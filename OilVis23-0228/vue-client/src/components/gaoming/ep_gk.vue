<template>
    <div> 
        ...
        <el-table
            ...
            <el-table-column prop="valve_state" label="MOV019阀门状态" width="110" :formatter="valve_stateFormat"></el-table-column>
            <el-table-column prop="valve_leakage" label="MOV019阀门内漏状态" width="110" :formatter="valve_leakageFormat"></el-table-column>
