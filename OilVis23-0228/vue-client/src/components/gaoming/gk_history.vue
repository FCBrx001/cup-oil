    ...
    <div>  
        <div style="width:100%">
            ...
            <el-table
                ...
                <el-table-column prop="station" label="站名" width="60"></el-table-column>
                <el-table-column prop="datetime" label="时间"  width="110" ></el-table-column>
                
                <el-table-column prop="valve_state" label="MOV011阀门状态" width="90" :formatter="valve_stateFormat"></el-table-column>
                <el-table-column prop="valve_leakage" label="MOV011阀门内漏状态" width="90" :formatter="valve_leakageFormat"></el-table-column>
                <el-table-column prop="pig_state" label="清管状态" width="65" :formatter="pig_stateFormat"></el-table-column>
                <el-table-column prop="pump_state" label="主输泵状态" width="70" :formatter="pump_stateFormat"></el-table-column>
                <el-table-column prop="state" width="80" label="处理状态" ></el-table-column>
            
                <el-table-column :render-header="renderHeader"  width="165">
    ...
    export default{
        ...
        methods: {
            ...
            changeeventdia(row){
                ...
                eventBus.$emit('gm_gk_zql_error',this.eventerror_times)
                //处理事件状态逻辑
            ...
            eventsuredia(row){
                ...
                eventBus.$emit('gm_gk_zql_sure',this.eventsure_times)
                //处理事件状态逻辑
