    ...
    <div>  
        <div style="width:100%">
            ...
            <el-table
                ...
                <el-table-column prop="valve_state" label="EVO011A阀门状态" width="90" :formatter="valve_stateFormat"></el-table-column>
                <el-table-column prop="valve_leakage" label="EVO011A阀门内漏状态" width="90" :formatter="valve_leakageFormat"></el-table-column>
...
.el-pagination .btn-next, .el-pagination .btn-prev {
    background: center center no-repeat #000c3b;
}
