<template>
    <div> 
        ...
        <el-table
            ...
            <el-table-column prop="valve_state" label="MOV014阀门状态" width="128" :formatter="valve_stateFormat"></el-table-column>
            <el-table-column prop="valve_leakage" label="MOV014阀门内漏状态" width="128" :formatter="valve_leakageFormat"></el-table-column>
    ...
    export default{
        ...
        methods: {
            ...
            changeeventdia(row)
            {
                ...
                eventBus.$emit('ss_gk_zql_error',this.eventerror_times)
                //处理事件状态逻辑
                console.log('更改当前行',row)
            ...
            eventsuredia(row){
                //连接ep_gk_zql组件
                this.eventsure_times++
                eventBus.$emit('ss_gk_zql_sure',this.eventsure_times)
                //处理事件状态逻辑
                console.log('更改当前行',row)
                for(let i=0;i<5;i++)
                {
