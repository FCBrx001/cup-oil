<template>
    <div>
        ...
        <el-table :data="tableData" :cell-style="setCellColor" :row-class-name="tableRowClassName"
            :header-cell-style="tableHeaderColor" style="width: 100% height: 100%">

            <el-table-column prop="station" label="站名" width="128"></el-table-column>
            <!-- <el-table-column prop="uuid" v-if="false" label="警告Id" width="128"></el-table-column> -->
            <el-table-column prop="datetime" label="时间" width="123"></el-table-column>

            <el-table-column prop="valve_state" label="MOV012阀门状态" width="128"
                :formatter="valve_stateFormat"></el-table-column>
            <el-table-column prop="valve_leakage" label="MOV012阀门内漏状态" width="128"
                :formatter="valve_leakageFormat"></el-table-column>
            <el-table-column prop="pig_state" label="清管状态" width="128" :formatter="pig_stateFormat"></el-table-column>
            <!-- <el-table-column prop="pump_state" label="主输泵状态" style='width: 7%' :formatter="pump_stateFormat"></el-table-column> -->
            <el-table-column prop="state" label="处理状态" width="128"></el-table-column>
...
export default {
    ...
    mounted() {
        ...
        eventBus.$on('ep_datawarn', data => {
            //data是一个数组
            // console.log('ep_datawarn',data)
